...
// batch 171: 1 program dossier(s), 1 exam record(s).

export const programs = [
  {
    "body": "Transportation Safety Institute",
    "bodyUrl": null,
    "about": "Transportation Safety Institute is the awarding organization for the credentials listed on this page. It develops, administers, and maintains professional certification and examination programs within its field. Specific eligibility, fees, and renewal terms vary by individual credential — always confirm on the official program page.",
    "registrationSteps": [
    ...
    "orgFaqs": [
      {
        "q": "How do I register for a Transportation Safety Institute credential?",
...
export const exams = [
  {
    ...
    "body": "Transportation Safety Institute",
    "tagline": "Transit Safety and Security Program Certificate — Transportation, Aviation & Maritime credential from Transportation Safety Institute",
    "description": "USDOT certificate programme for transit safety professionals covering system safety, security planning, emergency management and audits. Offered by Transportation Safety Institute, it is designed for candidates who need to demonstrate verified competence in the Transportation, Aviation & Maritime field. The credential is commonly used for career entry, advancement, regulatory compliance, or employer requirements. Candidates should review the official handbook for eligibility, exam format, and scoring before registering.",
    "quickAnswer": {
      "summary": "Transit Safety and Security Program Certificate is a professional credential administered by Transportation Safety Institute. It validates job-ready knowledge and skills in the Transportation, Aviation & Maritime field and is used for career entry, advancement, or compliance.",
      "advantages": [
        "Recognized credential from Transportation Safety Institute",
    ...
    "examMeta": {
      ...
      "admin": "Transportation Safety Institute"
    },
    "topics": [
      {
    ...
    "faqs": [
      {
        "q": "How do I register for the Transit Safety and Security Program Certificate exam?",
        "a": "Register through Transportation Safety Institute's official portal or an authorized test provider (e.g., Pearson VUE or Prometric where applicable). Create an account, select the exam, pay the fee, and schedule a date."
      },
      {
      ...
      },
      {
        ...
        "a": "Validity varies by credential (commonly 2–3 years). Renewal usually requires continuing education or a recertification exam — see Transportation Safety Institute's policy."
      },
      {
        "q": "What if I do not pass?",
        "a": "Most bodies allow retakes after a waiting period and payment of the full or partial fee. Check Transportation Safety Institute's retake policy before rescheduling."
      }
    ],
    "summaryPoints": [
      "Transit Safety and Security Program Certificate is awarded by Transportation Safety Institute.",
