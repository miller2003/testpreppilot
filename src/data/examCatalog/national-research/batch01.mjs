export const programs = [
  {
    ...
    "registrationSteps": [
      {
        ...
        "description": "Each ACAT credential has its own experience or education path; the ABA generally expects about three years of accounting practice, while the ATP is open to active preparers.",
        "duration": "varies"
      },
      {
        "title": "Apply and pay",
        "description": "Submit the application with the credential fee; some credentials require an annual membership or active-status fee on top of the exam fee.",
        "duration": "day"
      },
      {
        "title": "Schedule the exam",
        "description": "Book the computer-based exam at a Pearson VUE or partner center; the ABA spans two parts.",
        "duration": "15 minutes"
      },
      {
        "title": "Pass and maintain",
        "description": "A scaled score of 70 is required. Holders keep the credential with annual CPE and an active-status fee.",
        "duration": "per exam"
      }
    ],
      ...
      "rows": [
        {
          ...
          "values": [
            "Senior",
            "Full small-business accounting"
          ]
        },
        {
          "label": "ATA",
    ...
    "orgFaqs": [
      {
        "q": "Do ACAT credentials replace a CPA?",
        "a": "No. They accredit practitioners who may not be CPAs and demonstrate a defined scope of competence, often for small-business and individual tax work."
      },
      {
        "q": "Is the ATP exempt from the AFSP requirements?",
        "a": "The ATP is recognized by the IRS as satisfying the AFSP continuing-education expectations for unenrolled preparers, which eases the annual filing-season program for holders."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Become an ACFE member",
        "description": "Join the ACFE as an Associate member; membership is required to sit for and hold the CFE credential.",
        "duration": "day"
      },
      {
        "title": "Meet the points requirement",
        "description": "Earn CFE eligibility points from a mix of education, professional certifications and fraud-related experience; a bachelor degree plus two years of relevant experience is typical.",
        "duration": "varies"
      },
      {
        "title": "Prepare for the exam",
        "description": "Study the Fraud Examiners Manual across the exam sections; as of the 2026 update the exam has three sections rather than four.",
        "duration": "weeks to months"
      },
      {
        "title": "Sit and maintain",
        "description": "Pass the computer-based exam and keep the credential with annual CPE and ACFE membership.",
        "duration": "test day"
      }
    ],
    ...
    "comparison": {
      ...
      "rows": [
        ...
        {
          "label": "Prevention and Deterrence",
          "values": [
            "1.5 hrs",
            "70"
          ]
    ...
    "orgFaqs": [
      {
        "q": "Did the CFE exam change in 2026?",
        "a": "Yes. As of June 2, 2026 the exam moved from four sections to three (Fraud Schemes; Investigation and Legal; Prevention and Deterrence), with adjusted lengths and question counts."
      },
      {
        "q": "Must I be an ACFE member to call myself a CFE?",
        "a": "Yes. Active ACFE membership is a condition of holding the CFE credential, and you must keep membership current along with annual CPE."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Confirm eligibility",
        "description": "Candidates need a bachelor degree from an accredited school plus two years of government financial management experience, or equivalent combinations.",
        "duration": "varies"
      },
      {
        "title": "Apply and pay",
        "description": "Submit the AGA application with the one-time fee and the per-exam fee for each of the three CGFM exams.",
        "duration": "day"
      },
      {
        "title": "Schedule the three exams",
        "description": "Book Exam 1, 2 and 3 with the testing vendor at a center or online, in any order.",
        "duration": "15 minutes"
      },
      {
        "title": "Pass and maintain",
        "description": "Each exam is 115 questions in 135 minutes; pass all three and keep current with CPE and the annual fee.",
        "duration": "per exam"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Is the CGFM only for federal workers?",
        "a": "No. The CGFM serves federal, state and local government financial professionals, and the three exams cover all levels of the governmental environment."
      },
      {
        "q": "How long are CGFM scores valid?",
        "a": "You must pass all three exams within a set eligibility window, and once certified you maintain the credential with 80 CPE hours every two years."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Hold or pursue a CPA license",
        "description": "Most AICPA specialty credentials require an active CPA (CFF and PFS are CPA-only), though some valuation credentials also accept qualified non-CPAs with equivalent experience.",
        "duration": "n/a"
      },
      {
        "title": "Meet education and experience gates",
        "description": "Each credential sets its own hours of relevant experience and, for PFS, a block of personal-financial-planning CPE before you may sit.",
        "duration": "varies"
      },
      {
        "title": "Complete the exam or case requirement",
        "description": "ABV, CFF and PFS include a proctored exam; CEIV centers on a performance framework and attestation. Some allow a qualifying experience pathway instead.",
        "duration": "varies"
      },
      {
        "title": "Apply and maintain",
        "description": "Submit the application with fees and, once awarded, keep the credential current with AICPA CPE and membership rules.",
    ...
    "comparison": {
      ...
      "rows": [
        ...
        },
        {
          "label": "CEIV",
          "values": [
            "Entity and intangible valuation",
            "Preferred"
          ]
        },
        {
    ...
    "orgFaqs": [
      {
        "q": "Can a non-CPA earn an AICPA credential?",
        "a": "The ABV and CEIV valuation credentials accept qualified non-CPAs with the right education and experience, but CFF and PFS are restricted to active CPAs."
      },
      {
        "q": "Are these the same as the CPA license?",
        "a": "No. They are add-on specialties that sit on top of an active CPA or comparable license and show depth in one practice area. They do not replace the CPA."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Confirm your jurisdiction requirements",
        "description": "Each state board sets its own education rules, typically 150 semester hours, and its own experience requirement. Check your board before you apply so you sit the right sections.",
        "duration": "1 hour"
      },
      {
        "title": "Apply and receive a Notice to Schedule",
        "description": "Submit transcripts to your state board or NASBA, pay the application fee, and receive a Notice to Schedule (NTS) valid for a set window, commonly six to nine months.",
        "duration": "2 to 6 weeks"
      },
      {
        "title": "Schedule each section",
        "description": "Using the NTS, book AUD, FAR and REG (the three Core sections) and your chosen Discipline (BAR, ISC or TCP) at a Prometric test center.",
        "duration": "15 minutes"
      },
      {
        "title": "Pay the exam fees",
        "description": "Fees are charged per section and vary by jurisdiction; a typical section runs about $262 plus a one-time application fee around $96.",
        "duration": "5 minutes"
      },
      {
        "title": "Sit the exam and get scores",
        "description": "Each section is four hours at a Prometric center. Scores release on a fixed schedule through NASBA and post to your candidate account.",
        "duration": "test day"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Can I take the sections in any order?",
        "a": "Yes. You may sit the three Core sections in any sequence, then choose and sit one Discipline. Most candidates do FAR or AUD first, but the order is your call."
      },
      {
        "q": "What happens if my NTS expires?",
        "a": "An expired NTS means you forfeit that section fee and must reapply and repay to get a new one. Track the validity window carefully so you do not lose paid attempts."
      }
    ],
  ...
  },
  {
    ...
    "about": "The American Institute of Professional Bookkeepers (AIPB) is the bookkeeping profession's national association and awards the Certified Bookkeeper (CB) designation, the recognized benchmark for full-charge bookkeepers. The CB requires passing a four-part exam and demonstrating about two years of experience, then agreeing to the AIPB Code of Ethics. AIPB maintains a network of approved continuing-education providers for credential upkeep.",
    "registrationSteps": [
      {
        "title": "Confirm experience track",
        "description": "Plan to show at least 2 years of full-time bookkeeping experience (or 3,000 part-time/freelance hours) within three years of passing the exam. Students may count internships and accounting-related volunteer work.",
        "duration": "within 3 years of passing"
      },
      {
        "title": "File the paper application",
        "description": "Complete and mail the signed CB application with the nonrefundable registration fee ($25 AIPB member / $60 nonmember). Allow about 4 weeks for AIPB to process it.",
        "duration": "~4 weeks processing"
      },
      {
        "title": "Receive your testing ID",
        "description": "Once approved, AIPB mails a testing identification number you use to schedule Prometric appointments.",
        "duration": "after approval"
      },
      {
        "title": "Schedule and pass Prometric Parts 1 & 2",
        "description": "Book the two closed-book computer tests at a Prometric center in any order: Adjustments & Error Correction, and Payroll & Depreciation (2 hours, 75% to pass each). You get your score immediately.",
        "duration": "within 1 year of application"
      },
      {
        "title": "Complete the workbook finals (Parts 3 & 4)",
        "description": "Finish the open-book Inventory and Internal Controls & Fraud Prevention finals included in the study workbooks (untimed, 70% to pass). Submit them to AIPB for grading.",
        "duration": "within 3 years"
      },
      {
        "title": "Submit experience and ethics, get the CB",
        "description": "Provide the experience evidence form(s) and sign the AIPB Code of Ethics. AIPB issues your certificate within about two weeks of the last requirement.",
        "duration": "within 3 years of passing"
      }
    ],
    "proctoring": "Parts 1 and 2 are closed-book, computerized tests delivered at Prometric Test Centers (300+ U.S. locations) with live center proctoring. Parts 3 and 4 are open-book workbook finals completed at home and submitted to AIPB.",
    "retakePolicy": "If you fail a Prometric part, you may retake just that test after a 30-day waiting period for a $60 fee (you keep credit for any part you passed). The open-book workbook finals (Parts 3–4) may be retaken at no cost.",
    "recertification": "Certified Bookkeepers must complete 60 continuing professional education (CPE) hours every three years, measured from the anniversary of the last certification test passed. CPE must come from AIPB-recognized providers; failure to meet the requirement can result in revocation of the designation.",
    "scoreReporting": "Prometric prints your score at the center immediately after Parts 1 and 2. Workbook finals (Parts 3–4) are graded by AIPB after submission; results are reported to you and reflected in your AIPB record.",
    "providersNote": "Prometric delivers the closed-book parts; AIPB grades the workbook finals directly. Study workbooks (Mastering Inventory; Mastering Internal Controls and Fraud Prevention) can be bought individually or as a bundle, and the CB is distinct from the NACPB CPB license.",
    "comparison": {
      ...
      "rows": [
        ...
        },
        {
          ...
          "values": [
            "NACPB",
            "3 online exams (Bookkeeping, Payroll, QuickBooks)",
            "75% each; 1 yr exp",
            "License: 24 CPE / yr (annual)"
          ]
        },
        {
    ...
    "orgFaqs": [
      {
        "q": "Do I need a degree to earn the CB?",
        "a": "No. The CB is experience-based, not degree-based. You need about two years of bookkeeping experience (or 3,000 part-time hours), which can be earned within three years of passing the exam."
      },
      {
        "q": "Can I take the Prometric parts in any order?",
        "a": "Yes. Although labeled Part 1 and Part 2, the two Prometric tests may be taken in any order, and credit is kept for any part you pass even if you later retake another."
      },
      {
        "q": "How do I maintain the designation?",
        "a": "Complete 60 AIPB-approved CPE hours every three years and stay in good standing with the AIPB Code of Ethics. Approved providers include AIPB's own courses and recognized partners."
      }
    ],
    "sourceUrl": "https://www.aipb.org",
    "verified": true,
    "confidence": "high",
    "refundPolicy": "The registration fee is nonrefundable. Prometric test fees are generally nonrefundable once scheduled, though you can cancel or reschedule without penalty if you contact Prometric at least two days before the appointment."
  },
  {
    "id": "asa",
    ...
    "registrationSteps": [
      {
        "title": "Complete principles coursework",
        "description": "Aspiring BV designees take the ASA principles of valuation series (BV 201 through 204) or an approved challenge route before sitting the exams.",
        "duration": "months"
      },
      {
        "title": "Meet the experience requirement",
        "description": "The AM requires about two years of full-time valuation experience; the senior ASA requires about five years plus a report-review demonstration.",
        "duration": "years"
      },
      {
        "title": "Pass the examinations",
        "description": "Sit the ASA business valuation exams, which combine multiple-choice testing with case or report components depending on the level.",
        "duration": "per exam"
      },
      {
        "title": "Apply and reaccredit",
        "description": "Submit the designation application with experience evidence; reaccredit every five years with continuing education and an ethics attestation.",
        "duration": "per cycle"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "What is the difference between AM and ASA?",
        "a": "The Accredited Member is the entry BV designation requiring about two years of experience, while the Accredited Senior Appraiser requires about five years and a reviewed valuation report."
      },
      {
        "q": "Do I need the principles courses?",
        "a": "Most candidates complete the BV 201 to 204 principles series, though an approved challenge route can substitute for experienced valuators."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Join ASMC and enroll",
        "description": "Register through the ASMC CDFM program; members receive a discount on the enrollment and exam fees.",
        "duration": "day"
      },
      {
        "title": "Study the three modules",
        "description": "Prepare for Module 1 (defense resource management), Module 2 (budget and cost analysis) and Module 3 (accounting and finance), using the official body of knowledge.",
        "duration": "weeks"
      },
      {
        "title": "Schedule the exams",
        "description": "Book each module exam at a testing center or online; modules may be taken separately or together.",
        "duration": "15 minutes"
      },
      {
        "title": "Certify and maintain",
        "description": "Pass all three modules and keep the credential current with continuing education and the annual fee.",
        "duration": "per module"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Who should pursue the CDFM?",
        "a": "Defense and federal financial management professionals, including civilians, military and contractors working in DoD comptroller functions, are the primary audience."
      },
      {
        "q": "Can I take the modules separately?",
        "a": "Yes. Most candidates schedule the three module exams individually as they study, though they may also sit them together within the enrollment window."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Create an IIA account and apply",
        "description": "Apply through theiia.org, submitting education and character references; approval opens a three-year window to pass all CIA parts.",
        "duration": "weeks"
      },
      {
        "title": "Pay the application and exam fees",
        "description": "Fees differ for IIA members and non-members and are paid per part; a one-time application fee applies.",
        "duration": "5 minutes"
      },
      {
        "title": "Schedule each part",
        "description": "Book Part 1, 2 and 3 with Pearson VUE at a center or online, in any order you choose.",
        "duration": "15 minutes"
      },
      {
        "title": "Sit and pass the parts",
        "description": "Parts are computer-based multiple-choice exams of 100 to 125 questions. Scores post immediately at the center.",
        "duration": "per part"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Is the CIA recognized outside the US?",
        "a": "Yes. The CIA is the only globally recognized internal audit certification and is respected by employers in more than 170 countries."
      },
      {
        "q": "What happened to the CGAP?",
        "a": "The CGAP was retired; the last exams were offered through June 30, 2021 and existing holders maintain it through IIA CPE. It is no longer bookable."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Join IMA and register",
        "description": "Pay the IMA membership and the CMA entrance fee, then enroll in the two-part program through imanet.org.",
        "duration": "15 minutes"
      },
      {
        "title": "Meet the education and experience rule",
        "description": "Hold a bachelor degree or qualifying professional credential; you may sit the exam before finishing the two years of management accounting experience, which is required to certify.",
        "duration": "varies"
      },
      {
        "title": "Schedule each part",
        "description": "Book Part 1 and Part 2 with Prometric at a center or online; each is four hours with multiple-choice and essays.",
        "duration": "15 minutes"
      },
      {
        "title": "Pass and certify",
        "description": "Score 360 or higher on the 0 to 500 scale for each part, then submit proof of the required experience to be certified.",
        "duration": "per part"
      }
    ],
      ...
      "rows": [
        {
          ...
          "values": [
            ...
            "Reporting, budgeting, cost, controls"
          ]
        },
        {
          "label": "Part 2",
          "values": [
            "Strategic finance",
            "Analysis, corporate finance, ethics"
          ]
        }
      ]
    },
    "orgFaqs": [
      {
        "q": "Can I sit the CMA before I have the experience?",
        "a": "Yes. You may pass both parts first and then submit the two years of management accounting experience later to be certified; the exam result stays valid."
      },
      {
        "q": "How is the CMA different from the CPA?",
        "a": "The CPA centers on audit, tax and assurance in public practice, while the CMA focuses on internal management accounting, planning and decision support inside organizations."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Create an Intuit account",
        "description": "Sign up at the Intuit Academy or QuickBooks Training portal with the account you will use for hiring or client work.",
        "duration": "10 minutes"
      },
      {
        "title": "Complete the training",
        "description": "Work through the free lessons for Intuit Academy Tax (Level 1 and Level 2) or the QuickBooks Online ProAdvisor modules at your own pace.",
        "duration": "hours to weeks"
      },
      {
        "title": "Pass the assessment",
        "description": "Take the online assessment; the Academy Tax track is used as a screening step for remote seasonal preparer roles.",
        "duration": "per exam"
      },
      {
        "title": "Maintain the credential",
        "description": "Renew product certifications as new versions release and keep skills current for marketplace or client work.",
        "duration": "yearly"
      }
    ],
    ...
    "comparison": {
      ...
      "rows": [
        {
          "label": "Intuit Academy Tax",
          "values": [
            "Tax preparer hiring route",
            "Free"
          ]
        },
        {
    ...
    "orgFaqs": [
      {
        "q": "Is Intuit Academy Tax a real certification?",
        "a": "It is a free training-and-assessment track Intuit uses to screen candidates for seasonal tax preparer roles; it signals readiness but is not a state license."
      },
      {
        "q": "Does the ProAdvisor cert help me get bookkeeping clients?",
        "a": "Yes. The QuickBooks ProAdvisor badge is widely recognized by small businesses and appears in Intuit’s advisor directory that clients search."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Obtain a Preparer Tax Identification Number (PTIN)",
        "description": "Anyone who prepares federal returns for pay must hold an active PTIN from IRS.gov before they can sit the SEE or renew credentials.",
        "duration": "15 minutes"
      },
      {
        "title": "Prepare for the SEE",
        "description": "Study the three parts using the IRS published examination topics and commercial materials; there is no formal class requirement to sit.",
        "duration": "months"
      },
      {
        "title": "Schedule each part",
        "description": "Book Part 1, 2 and 3 of the Special Enrollment Examination with the current vendor (PSI, which replaced Prometric in 2026) at a testing center or online.",
        "duration": "15 minutes"
      },
      {
        "title": "Pass all three parts",
        "description": "Each part is a 100-question, 3.5-hour exam. You may take them in any order, and parts passed stay valid while you finish the rest.",
        "duration": "per part"
      },
      {
        "title": "Apply for enrollment",
        "description": "Submit Form 23 and the enrollment fee to the IRS, pass a tax-compliance check, then receive enrolled-agent status with unlimited representation rights.",
        "duration": "weeks"
      }
    ],
    ...
    "comparison": {
      ...
      "rows": [
        {
          "label": "AFSP Record of Completion",
          "values": [
            "Limited (current-year returns)",
            "18 hours CE + AFTR test"
          ]
        },
        {
          "label": "Certifying Acceptance Agent",
          "values": [
            "ITIN document certification",
            "Forensic + ITIN training"
          ]
        },
        {
          "label": "Enrolled Agent",
          "values": [
            "Unlimited before the IRS",
            "Pass all 3 SEE parts"
          ]
        }
      ]
    },
    "orgFaqs": [
      {
        "q": "Do I need the SEE to become an Enrolled Agent?",
        "a": "Almost always. You either pass all three parts of the Special Enrollment Examination or qualify through certain recent IRS employment. The exam route is the standard path."
      },
      {
        "q": "What changed with the 2026 PSI transition?",
        "a": "Starting March 1, 2026 the SEE moved from Prometric to PSI for delivery, and scoring shifted to a 200 to 800 scale with a 500 passing mark. The content and part structure stayed the same."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Confirm eligibility",
        "description": "The CVA generally requires a CPA or a business degree with valuation experience; the MAFF builds on the CVA core with a specialty track.",
        "duration": "n/a"
      },
      {
        "title": "Train and submit the case",
        "description": "Complete the required NACVA training and submit a case study or a sanitized valuation report demonstrating real engagement work.",
        "duration": "months"
      },
      {
        "title": "Sit the proctored exam",
        "description": "Take the CVA proctored multiple-choice examination; the MAFF adds a specialty exam once the core is met.",
        "duration": "per exam"
      },
      {
        "title": "Maintain the credential",
        "description": "Keep current with NACVA membership, continuing education and the annual credential fee.",
        "duration": "per year"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Do I need a CPA for the CVA?",
        "a": "A CPA is the most common path, but NACVA also accepts candidates with a business degree and sufficient valuation experience, so non-CPAs can qualify."
      },
      {
        "q": "What is the case requirement?",
        "a": "Beyond the exam, the CVA requires a submitted case study or a sanitized valuation report that shows you can perform a real engagement to standard."
      }
    ],
  ...
  },
  {
    ...
    "registrationSteps": [
      {
        "title": "Choose CPP or FPC",
        "description": "The FPC has no experience requirement and suits entry-level staff, while the CPP expects three of the last five years in payroll or a related degree.",
        "duration": "n/a"
      },
      {
        "title": "Prepare with the outline",
        "description": "Study the official PayrollOrg content outline covering Core, Compliance, Calculations, Systems, Administration, Audit and Accounting.",
        "duration": "weeks to months"
      },
      {
        "title": "Register for the exam",
        "description": "Book the exam through PayrollOrg during a window; members pay a lower fee than non-members.",
        "duration": "15 minutes"
      },
      {
        "title": "Sit and maintain",
        "description": "The CPP is 190 questions in four hours; the FPC is 150 questions in three hours. Renew by recertification before expiry.",
        "duration": "test day"
      }
    ],
    ...
    "orgFaqs": [
      {
        "q": "Which should I take first, FPC or CPP?",
        "a": "If you are new to payroll, the FPC has no experience barrier and builds fundamentals. The CPP is the senior credential and expects three years of recent payroll work."
      },
      {
        "q": "How do I keep the CPP current?",
        "a": "You renew every five years with 120 recertification credits through PayrollOrg-approved education, or by retaking the exam before it lapses."
      }
    ],
...
export const exams = [
  {
    ...
    "roadmap": [
      "Confirm eligibility (~3 yrs experience)",
      "Apply to ACAT",
      "Schedule the two-part exam",
      "Pass at scaled 70",
      "Maintain with CPE"
    ],
    ...
    "costBreakdown": {
      ...
      "total": "$400 to $650",
      "footnote": "ACAT member and non-member rates differ; an active-status fee applies annually."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "Is the ABA the same as a CPA?",
        "a": "No. The ABA accredits small-business accounting competence without the 150-hour rule or audit rights; it is a strong credential for practitioners who do not need the full CPA license."
      },
      {
        "q": "How is it structured?",
        "a": "Two 100-question parts of three hours each, with a scaled pass mark of 70."
      },
      {
        "q": "What experience is needed?",
        "a": "ACAT generally expects about three years of accounting practice, or a mix of education and experience, before you sit."
      },
      {
        "q": "How do I keep it?",
        "a": "Hold the ABA with about 120 hours of CPE over three years and an annual active-status fee."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Confirm tax experience",
      "Apply to ACAT",
      "Schedule the ATA exam",
      "Pass at scaled 70",
      "Maintain with CPE"
    ],
    ...
    "costBreakdown": {
      "items": [
        ...
        {
          "item": "Annual active fee",
          "fee": "$150 (about)"
        }
      ],
      "total": "$400 to $600",
      "footnote": "Rates vary by ACAT membership status."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "How is the ATA different from the ATP?",
        "a": "The ATP is the entry-level preparer accreditation; the ATA is the advanced credential for proactive, multi-year tax planning and strategy."
      },
      {
        "q": "What does it cover?",
        "a": "Retirement, estate, business and entity tax planning, plus the multi-year thinking that distinguishes advisory work."
      },
      {
        "q": "Do I need a CPA?",
        "a": "No. The ATA is open to experienced tax practitioners without a CPA, which is part of its appeal."
      },
      {
        "q": "How do I keep it current?",
        "a": "About 40 hours of CPE per year plus an annual ACAT active-status fee."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      ...
      [
        "IRS",
        "Counts toward AFSP expectations"
      ],
      [
        "Maintain",
        "CPE + active fee"
    ...
    "faqs": [
      {
        "q": "Who is the ATP for?",
        "a": "Preparers who file individual returns and want a recognized credential without the advanced planning scope of the ATA."
      },
      {
        "q": "Does it satisfy the AFSP?",
        "a": "Yes. The IRS recognizes the ATP as meeting the Annual Filing Season Program expectations for unenrolled preparers."
      },
      {
        "q": "What is the pass mark?",
        "a": "A scaled score of 70 on the 100-question exam."
      },
      {
        "q": "How does it relate to the EA?",
        "a": "The ATP is an accreditation for individual return prep; the Enrolled Agent is the IRS credential with full representation rights after passing the three-part SEE."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      [
        "Credential",
        "AICPA specialty for CPAs"
      ],
      [
        "Requirement",
        "CPA + exam + valuation experience"
      ],
      [
        "Focus",
        "Business valuation and reporting"
      ],
      [
        "Maintain",
        "AICPA CPE and membership"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Exam and application",
          "fee": "Varies by AICPA membership"
        }
      ],
      "total": "$300 to $1,000",
      "footnote": "AICPA members receive lower fees; study materials are an added cost."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Do I need a CPA for the ABV?",
        "a": "Yes, the ABV is an AICPA specialty built on an active CPA license, so it is intended for CPAs rather than general valuators."
      },
      {
        "q": "What does the exam cover?",
        "a": "Engagement acceptance, the major valuation approaches and methods, discounts and premiums, and report writing to professional standards."
      },
      {
        "q": "How does it compare to the NACVA CVA?",
        "a": "Both certify business valuators; the ABV is CPA-centric and AICPA-branded, while the CVA is offered by NACVA and also accepts non-CPAs with business degrees."
      },
      {
        "q": "Is there a case requirement?",
        "a": "The ABV centers on the proctored exam plus experience; some candidates use a qualifying experience pathway instead of the full exam."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      [
        "Credential",
        "AICPA forensic specialty for CPAs"
      ],
      [
        "Requirement",
        "CPA + exam + forensic experience"
      ],
      [
        "Focus",
        "Fraud, damages, testimony"
      ],
      [
        "Maintain",
        "AICPA CPE and membership"
    ...
    "costBreakdown": {
      ...
      "total": "$300 to $1,000",
      "footnote": "AICPA members receive lower fees."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Is the CFF only for CPAs?",
        "a": "Yes. Unlike some forensics credentials, the CFF requires an active CPA license, which is part of why it carries weight in court."
      },
      {
        "q": "What does the exam cover?",
        "a": "Fraud prevention and detection, investigation methods, damages and lost-profit analysis, and the mechanics of expert testimony."
      },
      {
        "q": "How does it compare to the CFE?",
        "a": "The CFE (from the ACFE) is open to a broader audience and covers fraud examination, while the CFF is a CPA-only AICPA specialty with a forensic-accounting emphasis."
      },
      {
        "q": "Do I need a case study?",
        "a": "The CFF is centered on the proctored exam and experience; some candidates use a qualifying experience pathway instead of the full exam."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      [
        "Credential",
        "AICPA planning specialty for CPAs"
      ],
      [
        "Requirement",
        "CPA + PFP CPE + exam"
    ...
    "costBreakdown": {
      ...
      "total": "$300 to $1,000",
      "footnote": "AICPA members receive lower fees; planning CPE is an added cost."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "Do I need a CPA for the PFS?",
        "a": "Yes. The PFS is an AICPA credential restricted to active CPAs, which distinguishes it from general financial planner designations."
      },
      {
        "q": "What experience is required?",
        "a": "You need personal financial planning experience plus a set number of personal-financial-planning CPE hours, then the PFS exam."
      },
      {
        "q": "How does it compare to the CFP?",
        "a": "The CFP is the broad financial-planning mark open to many, while the PFS is CPA-only and emphasizes the tax integration CPAs already know."
      },
      {
        "q": "Is there an exam?",
        "a": "Yes, the PFS includes a proctored exam on top of the experience and CPE requirements."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "body": "American Institute of Professional Bookkeepers (AIPB)",
    "tagline": "AIPB's four-part national bookkeeping credential — the experience-based benchmark for full-charge bookkeepers.",
    "description": "The Certified Bookkeeper (CB) is the national bookkeeping credential from the American Institute of Professional Bookkeepers (AIPB), established as the benchmark for full-charge bookkeepers. It is earned through a four-part exam: two closed-book tests at Prometric — Adjustments & Error Correction and Payroll & Depreciation — plus two open-book workbook finals on Inventory and Internal Controls & Fraud Prevention. Candidates also need about two years of bookkeeping experience (or 3,000 part-time hours) within three years of passing and must agree to the AIPB Code of Ethics. With a 75% pass mark on the Prometric parts and 70% on the workbook finals, the CB signals professional competence in the adjustments and controls that separate a bookkeeper from a data-entry clerk.",
    "quickAnswer": {
      "summary": "The AIPB Certified Bookkeeper (CB) is a four-part national credential: two closed-book Prometric tests (Adjustments & Error Correction; Payroll & Depreciation) and two open-book workbook finals (Inventory; Internal Controls & Fraud Prevention). You also need ~2 years of bookkeeping experience and must sign the AIPB Code of Ethics.",
      "advantages": [
        "Nationally recognized benchmark for full-charge bookkeepers",
        "Experience-based, not degree-based — open to working bookkeepers",
        "Covers the adjustments, controls, payroll, and fraud prevention employers value",
        "Backed by the AIPB Code of Ethics and a 300+ location Prometric network",
        "Renewable through AIPB-approved continuing education"
      ]
    },
    "roadmap": [
      "Confirm you have (or will earn) ~2 years of bookkeeping experience",
      "File the paper application and pay the registration fee",
      "Wait for AIPB to issue your testing ID number",
      "Schedule and pass Prometric Parts 1 & 2 (2 hours each)",
      "Complete the open-book Inventory and Internal Controls workbook finals",
      "Submit experience proof and sign the Code of Ethics to receive the CB"
    ],
    "prerequisites": "There is no education prerequisite. You must, however, meet the experience requirement (about 2 years full-time or 3,000 part-time/freelance hours) and sign the AIPB Code of Ethics to be awarded the designation.",
    "examMeta": {
      "questions": "Multiple-choice; item counts per test are not published. Six tests total: two 2-hour Prometric tests per part for Parts 1–2, plus untimed workbook finals for Parts 3–4",
      "time": "2 hours each for Prometric Parts 1 & 2; Parts 3–4 are untimed open-book finals",
      "pass": "75% on Prometric Parts 1 & 2; 70% on workbook Parts 3 & 4",
      "fee": "Registration $25 member / $60 nonmember (nonrefundable) + $100 each for Prometric Parts 1 & 2; Parts 3–4 have no exam fee (study workbooks extra)",
      "format": "Closed-book computerized tests at Prometric (Parts 1–2); open-book workbook finals (Parts 3–4)",
      "admin": "American Institute of Professional Bookkeepers (AIPB); Prometric delivers Parts 1–2"
    },
    "topics": [
      {
        "name": "Part 1, Test 1 — Adjustments",
        "note": "Accruals, deferrals, and the adjusted trial balance; month-end financial statement preparation"
      },
      {
        "name": "Part 1, Test 2 — Error Correction & Bank Reconciliation",
        "note": "Locating bookkeeping errors, trial-balance analysis, and reconciling bank accounts"
      },
      {
        "name": "Part 2, Test 1 — Payroll",
        "note": "Worker classification, withholding, deposits, Forms W-4/941/940/W-2/W-3, and payroll journal entries"
      },
      {
        "name": "Part 2, Test 2 — Depreciation",
        "note": "Book vs tax depreciation, straight-line and accelerated GAAP methods, units-of-production, MACRS basics"
      },
      {
        "name": "Part 3 — Inventory",
        "note": "Perpetual vs periodic systems, FIFO/LIFO/weighted-average, shrinkage, lower of cost or net realizable value (open-book workbook final)"
      },
      {
        "name": "Part 4 — Internal Controls & Fraud Prevention",
        "note": "Segregation of duties, noncash asset theft, check/credit-card fraud, vendor scams, and computer fraud controls (open-book workbook final)"
      }
    ],
    "examEssentials": [
      [
      ...
      [
        "Structure",
        "4 parts (2 Prometric tests + 2 workbook finals)"
      ],
      [
        "Passing scores",
        "75% Parts 1–2; 70% Parts 3–4"
      ],
      [
        "Experience",
        "2 yrs full-time or 3,000 hrs part-time within 3 yrs"
      ],
      [
        "Code of Ethics",
        "Required to be awarded the designation"
      ],
      [
        "Renewal",
        "60 CPE hours every 3 years"
      ]
    ],
    "timeline": [
      [
      ...
      [
        "Pass Prometric parts",
        "Within 1 year of application (parts in any order)"
      ],
      [
        "Complete workbook finals",
        "Within 3 years of starting"
      ],
      [
        "Submit experience + ethics",
        "Within 3 years of passing exam"
      ],
      [
        "Receive certificate",
        "Within ~2 weeks of final requirement"
      ]
    ],
    "costBreakdown": {
      "items": [
        [
          "Registration fee — AIPB member",
          "$25 (nonrefundable)"
        ],
        [
        ...
        [
          "Part 1 — Adjustments & Error Correction (Prometric)",
          "$100"
        ],
        [
          "Part 2 — Payroll & Depreciation (Prometric)",
          "$100"
        ],
        [
          "Parts 3–4 — workbook finals",
          "No exam fee"
        ],
        [
          "Study workbooks (optional prep)",
          "Extra (bundle ~$254 member / $314 nonmember)"
        ]
      ],
      "total": "$225 member / $260 nonmember minimum (registration + two Prometric parts); workbooks and prep are extra",
      "footnote": "Registration is nonrefundable. Retakes: $60 per Prometric test after a 30-day wait; Parts 3–4 may be retaken at no cost."
    },
    "difficulty": "Challenging",
    "audience": "Working bookkeepers, full-charge bookkeepers, and accounting assistants seeking a nationally recognized professional designation.",
    "time": "Study + testing typically several months; experience within 3 years of passing",
    "cost": "$225–$260 minimum (plus optional workbooks)",
    "faqs": [
      {
        "q": "How is the AIPB CB exam structured?",
        "a": "It is a four-part exam. Parts 1 and 2 are closed-book, multiple-choice tests taken at a Prometric center — Adjustments & Error Correction, and Payroll & Depreciation — each with a 2-hour limit. Parts 3 and 4 are untimed, open-book finals at the back of the Mastering Inventory and Mastering Internal Controls and Fraud Prevention workbooks."
      },
      {
        "q": "What score do I need to pass?",
        "a": "You need 75% on each Prometric part (Parts 1 and 2) and 70% on each workbook final (Parts 3 and 4). You can take the parts in any order and keep credit for any part you pass."
      },
      {
        "q": "How much does it cost?",
        "a": "A nonrefundable registration fee of $25 for AIPB members or $60 for nonmembers, plus $100 each for the two Prometric parts — a $225–$260 minimum before study workbooks or prep. The two workbook finals carry no separate exam fee."
      },
      {
        "q": "What are the experience requirements?",
        "a": "You need at least two years of full-time bookkeeping experience or 3,000 hours of part-time/freelance work, which can be completed within three years of passing the exam. Internships and accounting-related volunteer work may count for students."
      },
      {
        "q": "How do I keep the CB active?",
        "a": "Certified Bookkeepers must complete 60 continuing professional education (CPE) hours every three years, beginning on the anniversary of the last certification test passed. AIPB-approved providers supply the CPE."
      }
    ],
    "summaryPoints": [
      "Four-part exam: two 2-hour Prometric tests (75% to pass) plus two untimed open-book workbook finals (70%).",
      "Requires ~2 years of bookkeeping experience and signing the AIPB Code of Ethics to be awarded.",
      "Minimum direct cost is $225 (member) / $260 (nonmember) before study workbooks.",
      "Renew with 60 CPE hours every 3 years through AIPB-approved education."
    ],
    "relatedSlugs": [
    ...
    "reviewed": "2026-08",
    "confidence": "high",
    "eligibility": "The CB is open to working bookkeepers without a degree. You may take the exam before finishing the experience requirement, but you must accumulate at least two years of full-time bookkeeping experience (or 3,000 hours of part-time/freelance work) within three years of passing the exam. Undergraduates may count internships and accounting-related volunteer work such as VITA. You apply by mailing a signed paper application to AIPB, which then issues a testing ID number."
  },
  {
    ...
    "roadmap": [
      "Take BV 201-204 principles",
      "Pass the AM exams",
      "Document ~2 yrs experience",
      "Apply to ASA",
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Coursework and exam",
          "fee": "$1,000 to $3,000"
        }
      ],
      "total": "$1,000 to $3,500",
      "footnote": "Costs reflect ASA education and exam fees; members receive discounts."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "What is the AM?",
        "a": "The Accredited Member is ASA’s entry business-valuation designation, requiring principles coursework, exams and about two years of experience."
      },
      {
        "q": "How does it differ from the ASA?",
        "a": "The senior ASA requires about five years of experience and a reviewed valuation report; the AM is the earlier tier."
      },
      {
        "q": "Do I need the principles courses?",
        "a": "Most candidates complete BV 201 through 204; an approved challenge route can substitute for experienced valuators."
      },
      {
        "q": "How do I keep it?",
        "a": "Reaccredit every five years with continuing education and an ethics attestation."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Hold the AM or equivalent",
      "Complete BV exams",
      "Submit and pass a report review",
      "Document ~5 yrs experience",
      "Reaccredit every 5 years"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Report",
        "Reviewed valuation report required"
      ],
      [
        "Reaccredit",
        "Every 5 years"
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Coursework, exams and review",
          "fee": "$2,000 to $5,000"
        }
      ],
      "total": "$2,000 to $6,000",
      "footnote": "Reflects ASA education, exam and report-review fees; members receive discounts."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "What makes the ASA senior?",
        "a": "Beyond the exams, you must submit and pass a valuation report review and document about five years of full-time practice, which is why it signals senior-level competence."
      },
      {
        "q": "How does it differ from the AM?",
        "a": "The AM is the entry tier with about two years of experience; the ASA adds the report review and the deeper experience requirement."
      },
      {
        "q": "Is it useful for court work?",
        "a": "Yes. The senior ASA is widely relied on for expert testimony and transaction valuations because of its rigorous standards."
      },
      {
        "q": "How do I keep it?",
        "a": "Reaccredit every five years with continuing education, active practice and an ethics attestation."
      }
    ],
    "summaryPoints": [
    ...
    "relatedSlugs": [
      "asa-accredited-member-valuation",
      "aicpa-abv",
      "nacva-cva"
    ],
    "sourceUrl": "https://www.appraisers.org",
  ...
  },
  {
    ...
    "roadmap": [
      "Join ASMC",
      "Study the three modules",
      "Schedule the module exams",
      "Pass all three",
      "Maintain with CPE"
    ],
    ...
    "examEssentials": [
      [
        "Modules",
        "Three (resource, budget, accounting)"
      ],
      [
        "Format",
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Enrollment and exams",
          "fee": "$300 to $700"
        }
      ],
      "total": "$300 to $700",
      "footnote": "ASMC member rates are lower than non-member rates."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      ...
      {
        "q": "Can I take the modules separately?",
        "a": "Yes. Most candidates schedule the three module exams individually as they study, though they may also sit them together."
      },
      {
        "q": "How is it different from the CGFM?",
        "a": "The CGFM (AGA) serves government financial managers broadly, while the CDFM focuses on the defense and DoD financial management environment."
      },
      {
        "q": "How do I keep it?",
        "a": "Maintain with continuing education and the annual ASMC maintenance fee."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Hold a relevant license",
      "Complete VFR training",
      "Commit to the performance framework",
      "Apply to AICPA",
      "Maintain with CPE"
    ],
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Training and application",
          "fee": "Varies by AICPA membership"
        }
      ],
      "total": "$300 to $1,000",
      "footnote": "Fees depend on the training path and AICPA membership."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "What is the CEIV for?",
        "a": "It certifies that you can produce fair-value measurements of entities and intangibles that meet the AICPA’s Valuation for Financial Reporting framework, which auditors and filers rely on."
      },
      {
        "q": "Is there a timed exam?",
        "a": "The CEIV is built around completing the VFR performance framework and an attestation of compliance rather than a conventional timed multiple-choice exam."
      },
      {
        "q": "How does it differ from the ABV?",
        "a": "The ABV covers business valuation broadly, while the CEIV is narrowly focused on fair-value measurement for financial reporting."
      },
      {
        "q": "Who needs it?",
        "a": "Professionals whose valuation estimates flow into audit opinions and SEC filings gain the most credibility from the CEIV."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      "items": [
        ...
        {
          "item": "ACFE membership",
          "fee": "Annual"
        }
      ],
      "total": "$475+ plus membership",
      "footnote": "ACFE membership is required to hold the credential; exam fee reflects current ACFE pricing."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "How did the CFE change in 2026?",
        "a": "As of June 2, 2026 the exam moved from four sections to three: Fraud Schemes; Investigation and Legal; and Prevention and Deterrence, with adjusted lengths and question counts."
      },
      {
        "q": "Do I need ACFE membership?",
        "a": "Yes. Active ACFE membership is a condition of holding the CFE, and you must keep membership current along with annual CPE."
      },
      {
        "q": "What are the eligibility points?",
        "a": "You earn points from education, professional certifications and fraud-related experience; a bachelor degree plus about two years of relevant experience is a common path."
      },
      {
        "q": "Is the CFE hard?",
        "a": "It is demanding because it spans law, investigation and schemes; most candidates study the Fraud Examiners Manual for three to six months."
      },
      {
        "q": "How do I keep it?",
        "a": "Complete 20 hours of anti-fraud CPE each year and maintain ACFE membership."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Note: retired",
      "Pursue the CIA instead",
      "Add government-audit training",
      "Maintain any existing CGAP with CPE"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Holders",
        "Maintain with IIA CPE"
      ]
    ],
    "timeline": [
      {
        "stage": "Historical administration",
        "duration": "Through June 30, 2021"
      }
    ],
    "costBreakdown": {
      "items": [
        {
          "item": "Former exam fee",
          "fee": "Discontinued"
        }
      ],
      "total": "Discontinued",
      "footnote": "No longer bookable; shown for historical reference only."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Can I still take the CGAP?",
        "a": "No. The IIA retired the CGAP and the last exams were offered through June 30, 2021; the credential cannot be registered for today."
      },
      {
        "q": "What should I pursue instead?",
        "a": "Government internal auditors now pursue the CIA, the IIA’s flagship certification, plus government-audit and performance-audit training."
      },
      {
        "q": "Are existing CGAP holders affected?",
        "a": "Holders maintain the designation through IIA continuing education and renewal; the retirement mainly affects new candidates."
      },
      {
        "q": "Why was it retired?",
        "a": "The IIA consolidated its government-audit recognition into the CIA pathway and specialized training rather than a standalone credential."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Confirm degree + 2 yrs experience",
      "Apply to AGA",
      "Schedule the three exams",
      "Pass at 500/700",
      "Maintain with CPE"
    ],
    ...
    "costBreakdown": {
      ...
      "total": "$540+",
      "footnote": "AGA member rates differ; the figures reflect typical current AGA pricing."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Is the CGFM only for federal workers?",
        "a": "No. It serves federal, state and local government financial professionals, and the three exams cover all levels of the governmental environment."
      },
      {
        "q": "What experience is needed?",
        "a": "A bachelor degree plus two years of government financial management experience, or an equivalent combination of education and experience."
      },
      {
        "q": "How is it structured?",
        "a": "Three 115-question exams of 135 minutes each, scored 200 to 700 with a 500 passing mark."
      },
      {
        "q": "How do I keep it?",
        "a": "Complete 80 hours of CPE every two years and pay the annual AGA fee."
      },
      {
        "q": "How does it compare to the CDFM?",
        "a": "The CGFM is the broad government finance mark; the CDFM focuses specifically on the defense and DoD environment."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      ...
      [
        "Position",
        "First of three CIA parts"
      ],
      [
        "Window",
        "All parts within 3 years of approval"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "IIA application fee",
          "fee": "$120 (member) / $240 (non)"
        },
        {
          "item": "Part 1 exam fee",
          "fee": "$310 (member) / $445 (non)"
        }
      ],
      "total": "$430 to $685 for Part 1",
      "footnote": "Member rates apply to IIA members; non-member rates are higher."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "How hard is CIA Part 1?",
        "a": "Most candidates rate Part 1 moderate. It is conceptual and principle-based, so memorizing the IPPF and understanding governance and risk matter more than calculation."
      },
      {
        "q": "How long should I study?",
        "a": "Plan six to ten weeks with the IIA study materials, focusing on the internal audit mandate and the fraud-risk area."
      },
      {
        "q": "Can I take Part 1 alone?",
        "a": "Yes. Parts may be taken in any order, but most candidates start with Part 1 because it is the foundation for Parts 2 and 3."
      },
      {
        "q": "What is the pass mark?",
        "a": "The IIA uses a scaled pass mark on its exams; you receive a result at the center and a diagnostic by topic."
      },
      {
        "q": "How long are scores valid?",
        "a": "You must complete all three CIA parts within three years of your application approval, or the candidacy lapses."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      "items": [
        ...
        {
          "item": "Part 2 exam fee",
          "fee": "$280 (member) / $415 (non)"
        }
      ],
      "total": "$400 to $655 for Part 2",
      "footnote": "Member rates apply to IIA members; non-member rates are higher."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "How hard is CIA Part 2?",
        "a": "Candidates with audit experience usually find Part 2 the most approachable because it tracks real engagement workflow; newcomers need to learn the IIA engagement standards."
      },
      {
        "q": "How long should I study?",
        "a": "Five to eight weeks is typical, emphasizing planning, supervision and reporting communications."
      },
      {
        "q": "Should I take it after Part 1?",
        "a": "Most do, but the order is your choice; Part 2 complements Part 1’s concepts with the practice layer."
      },
      {
        "q": "What is the pass mark?",
        "a": "The IIA uses a scaled pass mark; results and a topic diagnostic appear at the center."
      },
      {
        "q": "How long are scores valid?",
        "a": "All three parts must be passed within three years of application approval."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      "items": [
        ...
        {
          "item": "Part 3 exam fee",
          "fee": "$280 (member) / $415 (non)"
        }
      ],
      "total": "$400 to $655 for Part 3",
      "footnote": "Member rates apply to IIA members; non-member rates are higher."
    },
    "difficulty": "Moderate",
    "audience": "Aspiring internal auditors",
    ...
    "faqs": [
      {
        "q": "How hard is CIA Part 3?",
        "a": "It is broad rather than deep; candidates without a finance or IT background spend extra time on financial management and IT controls."
      },
      {
        "q": "How long should I study?",
        "a": "Five to eight weeks, with emphasis on business acumen, security and analytics if those are newer to you."
      },
      {
        "q": "Is Part 3 required?",
        "a": "Yes. All three parts are required for the CIA; Part 3 supplies the business context that frames audit judgments."
      },
      {
        "q": "What is the pass mark?",
        "a": "The IIA uses a scaled pass mark; results and a topic diagnostic appear at the center."
      ...
      {
        "q": "How long are scores valid?",
        "a": "All three parts must be passed within three years of application approval, or the candidacy lapses."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "IMA entrance fee",
          "fee": "$300 (professional)"
        },
        {
          "item": "Part 1 exam fee",
          "fee": "$495 (professional member)"
        }
      ],
      "total": "$795+ for Part 1",
      "footnote": "Student and academic rates are lower; entrance fee is one-time."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "How hard is CMA Part 1?",
        "a": "Most candidates find Part 1 demanding because of the breadth from reporting to cost to controls, but the essay section rewards structured answers."
      },
      {
        "q": "How long should I study?",
        "a": "Three to six months of steady study with the official IMA materials is typical for Part 1."
      },
      {
        "q": "Can I take Part 2 first?",
        "a": "Yes. The order is your choice; many start with Part 1 because it covers the core planning and performance topics."
      },
      {
        "q": "What is the pass mark?",
        "a": "A scaled 360 on the 0 to 500 scale; the essay portion is a meaningful part of the score."
      },
      {
        "q": "Does passing Part 1 certify me?",
        "a": "No. You must pass both parts and meet the two-year experience rule, then submit proof to be certified."
      }
    ],
    "summaryPoints": [
      "First CMA part on planning and performance",
  ...
  },
  {
    ...
    "roadmap": [
      "Join IMA and enroll",
      "Study the Part 2 topics",
      "Schedule with Prometric",
      "Pass at 360/500",
      "Certify with experience"
    ],
    "prerequisites": "An IMA membership and CMA entrance; a bachelor degree or qualifying credential is needed to certify, though you may sit before finishing experience.",
    "examMeta": {
      "questions": "100 multiple-choice + 2 essays",
    ...
    "faqs": [
      {
        "q": "How hard is CMA Part 2?",
        "a": "Candidates often find Part 2 slightly more conceptual than Part 1, with corporate finance and decision analysis carrying the most weight."
      },
      {
        "q": "How long should I study?",
        "a": "Three to six months is typical, with extra time on decision analysis and investment decisions."
      },
      {
        "q": "Should I take it after Part 1?",
        "a": "Most do, but the order is flexible; Part 2 stands on its own finance and strategy content."
      },
      {
        "q": "What is the pass mark?",
        "a": "A scaled 360 on the 0 to 500 scale, including the essay component."
      },
      {
        "q": "What experience is needed to certify?",
        "a": "Two years of management accounting or finance experience, which you may complete after passing both exams."
      }
    ],
    "summaryPoints": [
      "Second CMA part on finance and strategy",
  ...
  },
  {
    ...
    "roadmap": [
      "Confirm state education rule",
      "Apply and get your NTS",
      "Pass the three Core sections",
      "Choose and pass one Discipline",
      "Meet experience to be licensed"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Pass mark",
        "Scaled 75 per section"
      ],
      [
        "Window",
        "18 or 30 months to pass all 4"
      ],
      [
        "Credential",
        "Leads to the CPA license"
      ]
    ],
    "timeline": [
      {
        "stage": "Study",
        "duration": "12 to 18 months total"
      },
      {
        "stage": "Test",
      ...
      {
        "stage": "Scores",
        "duration": "fixed release schedule"
      }
    ],
    "costBreakdown": {
      "items": [
        {
          "item": "Exam fee (4 sections)",
          "fee": "~$1,050"
        },
        {
          "item": "State application fee",
          "fee": "~$96 one-time"
        }
      ],
      "total": "$358 to $1,100 for all four",
      "footnote": "Fees vary by jurisdiction; review courses are an additional cost."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        ...
        "a": "Under CPA Evolution it is three Core sections (AUD, FAR, REG) that everyone takes, plus one Discipline (BAR, ISC or TCP) you choose based on your strengths and career aim."
      },
      {
        "q": "Can I take the sections in any order?",
        "a": "Yes. Most candidates do the three Core sections first and then the Discipline, but you may schedule them in any sequence within your Notice to Schedule window."
      },
      {
        "q": "How much does it cost?",
        "a": "About $262 per section plus a one-time state application fee around $96, so the four sections run roughly $1,050 to $1,100 excluding review course fees."
      },
      {
        "q": "Do the sections expire?",
        "a": "Yes. You must pass all four within your state’s rolling window, commonly 18 or 30 months from your first passed section, or earlier passes lapse."
      },
      {
        "q": "What happens after I pass?",
        "a": "Passing the exam lets your state board certify you as a CPA once you also meet the education and experience requirements and any ethics exam the state requires."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      ...
      "Apply and get your NTS",
      "Study the four AUD content areas",
      "Sit the 4-hour exam",
      "Score 75 or higher"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Validity",
        "All 4 sections within your jurisdiction window (18 or 30 months)"
      ],
      [
        "Weighting",
        "MCQ and TBS each about 50%"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      ...
      "total": "$358 to $1,100 for all four",
      "footnote": "Fees vary by jurisdiction; some states bundle the application fee per section."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "How hard is AUD?",
        "a": "Most candidates find AUD moderately hard. The conceptual material, especially risk assessment and internal control, is less mechanical than FAR, but the simulations demand professional judgment. Candidates with audit experience usually score higher."
      },
      {
        "q": "How long should I study?",
        "a": "A typical plan is 80 to 120 hours over eight to twelve weeks, with heavy time on task-based simulations in the final two weeks. Those weak in auditing usually add more."
      },
      {
        "q": "Is AUD required for everyone?",
        "a": "Yes. AUD is one of the three Core sections that every CPA candidate must pass, along with FAR and REG. Your Discipline choice (BAR, ISC or TCP) is the only elective."
      },
      {
        "q": "What score do I need?",
        "a": "The passing scaled score is 75 on a 0 to 99 scale. Because the scale is not a percentage, a 75 reflects the established standard of competence, not 75 percent correct."
      },
      {
        "q": "Does AUD expire?",
        "a": "Yes, like all sections. You must pass all four CPA sections within your state’s rolling window, commonly 18 or 30 months from your first passed section."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Pass the 3 Core sections",
      "Choose BAR as your Discipline",
      "Study advanced reporting topics",
      "Sit the 4-hour exam",
      "Score 75 or higher"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Type",
        "Elective Discipline (pick one of BAR, ISC, TCP)"
      ],
      [
        "Prerequisite",
        "All three Core sections first"
      ],
      [
        "Weighting",
        "MCQ and TBS each about 50%"
    ...
    "costBreakdown": {
      ...
      "total": "$358 to $1,100 for all four",
      "footnote": "Fees vary by jurisdiction."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Who should choose BAR?",
        "a": "Candidates who enjoyed FAR and want the deepest reporting content, especially those heading into technical accounting, corporate controllership or governmental finance, tend to choose BAR."
      },
      {
        "q": "Can I switch Discipline after starting?",
        "a": "Your Discipline is locked once you schedule it, but you may sit a different Discipline only if you have not yet passed one; check your jurisdiction rules before booking."
      },
      {
        "q": "How does BAR differ from FAR?",
        "a": "FAR is a required Core covering the broad reporting framework, while BAR is an elective that goes further into consolidations, derivatives, governmental and managerial topics."
      },
      {
        "q": "Is BAR harder than ISC or TCP?",
        "a": "Difficulty is personal. BAR is content-heavy like FAR, ISC is systems-oriented, and TCP is tax-oriented; pick the one matching your strengths rather than chasing an easy label."
      },
      {
        "q": "What score do I need?",
        "a": "A scaled 75 on the 0 to 99 scale, the same passing standard as every CPA section."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Confirm state eligibility",
      "Apply and get your NTS",
      "Master the FAR blueprint areas",
      "Sit the 4-hour exam",
      "Score 75 or higher"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Government",
        "Includes a state and local government component"
      ],
      [
        "Window",
        "All 4 sections within 18 or 30 months per state"
      ]
    ],
    "timeline": [
      {
    ...
    "faqs": [
      {
        "q": "How hard is FAR?",
        "a": "FAR is consistently the hardest section for most candidates because of its breadth. It covers more material than any other section, from pensions to leases to governmental accounting, so memorization and repetition matter."
      },
      {
        "q": "How long should I study?",
        "a": "Most candidates spend 120 to 180 hours across ten to sixteen weeks. The volume of topics means spreading study out beats cramming, and simulations need dedicated practice."
      },
      {
        "q": "Is FAR required?",
        "a": "Yes, FAR is a Core section every CPA candidate must pass, together with AUD and REG. Only your fourth section, the Discipline, is an elective."
      },
      {
        "q": "What is the pass mark?",
        "a": "A scaled score of 75 on the 0 to 99 scale is required. The score is not a percentage; it reflects the published competency standard."
      },
      {
        "q": "Why does FAR include government accounting?",
        "a": "Because CPAs in public practice and government frequently encounter state and local government financial statements, a portion of FAR tests that framework even for candidates who choose a different Discipline."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Pass the 3 Core sections",
      "Choose ISC as your Discipline",
      "Study systems, security and SOC",
      "Sit the 4-hour exam",
      "Score 75 or higher"
    ],
    ...
    "faqs": [
      {
        "q": "Who should choose ISC?",
        "a": "Candidates comfortable with technology, data and controls, and those aiming at IT audit or SOC advisory work, tend to choose ISC over the reporting- or tax-heavy disciplines."
      },
      {
        "q": "Do I need a tech background?",
        "a": "Not formally, but ISC assumes comfort with information systems concepts. A background in IT audit or ERP work helps, while pure tax people may prefer TCP."
      },
      {
        "q": "How does ISC relate to AUD?",
        "a": "AUD covers audit fundamentals including some controls, while ISC goes deeper into IT governance, security and SOC engagements, so the two reinforce each other."
      },
      {
        "q": "Is ISC easier than FAR?",
        "a": "It is narrower than FAR, but the systems vocabulary is new to many accountants. Choose it for fit, not perceived ease."
      },
      {
        "q": "What score do I need?",
        "a": "A scaled 75 on the 0 to 99 scale, the same standard as every CPA section."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      ...
      [
        "Focus",
        "Tax of individuals and entities plus business law"
      ],
      [
        "Window",
        "All 4 sections within 18 or 30 months"
      ]
    ],
    "timeline": [
      {
    ...
    "faqs": [
      {
        "q": "How hard is REG?",
        "a": "REG is moderately hard. The tax calculations are learnable, but the volume of rules and the business-law portion trip up candidates who focus only on math. Strong candidates drill both the code mechanics and the legal concepts."
      },
      {
        "q": "How long should I study?",
        "a": "Plan on 90 to 130 hours over eight to twelve weeks, with extra time on entity taxation and the simulations that integrate multiple topics."
      },
      {
        "q": "Is REG required?",
        "a": "Yes. REG is a Core section every candidate must pass, with AUD and FAR. Your Discipline (BAR, ISC or TCP) is the only choice."
      },
      {
        "q": "What score is needed?",
        "a": "A scaled 75 out of 99 is the passing standard, which is a competency benchmark rather than 75 percent of questions."
      },
      {
        "q": "Does REG help with the EA exam?",
        "a": "The federal tax content overlaps with the Special Enrollment Examination, so CPA candidates who pass REG carry useful knowledge toward the enrolled-agent credential, though the EA tests tax more deeply across three parts."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Pass the 3 Core sections",
      "Choose TCP as your Discipline",
      "Study advanced tax topics",
      "Sit the 4-hour exam",
      "Score 75 or higher"
    ],
    ...
    "faqs": [
      {
        "q": "Who should choose TCP?",
        "a": "Candidates who liked the tax content in REG and plan to practice tax or advise on planning usually choose TCP, the most tax-intensive of the three disciplines."
      },
      {
        "q": "Does TCP overlap with the EA exam?",
        "a": "Yes, there is real overlap with the Special Enrollment Examination, so a CPA who passes TCP carries strong knowledge toward the enrolled-agent credential."
      },
      {
        "q": "How is TCP different from REG?",
        "a": "REG is the required Core introducing federal tax; TCP is the elective that goes deeper into entity planning, individual strategy and specialized transactions."
      },
      {
        "q": "Is TCP the easiest discipline?",
        "a": "Not necessarily. It is familiar to tax-minded candidates, but the planning simulations are demanding. Choose it for strengths, not the rumor of ease."
      },
      {
        "q": "What score do I need?",
        "a": "A scaled 75 on the 0 to 99 scale, the same passing standard as every CPA section."
  ...
  },
  {
    ...
    "roadmap": [
      "Confirm 3-of-5-yr experience",
      "Study the 7-area outline",
      "Register with PayrollOrg",
      "Pass the 190-Q exam",
    ...
    "costBreakdown": {
      ...
      "total": "$419 to $1,100",
      "footnote": "2026 fee ranges; members pay less than non-members."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "How hard is the CPP?",
        "a": "Most candidates find it hard because of the breadth across law, tax, systems and accounting. Three to six months of steady study with the official outline is typical."
      },
      {
        "q": "What experience is required?",
        "a": "Three of the last five years in payroll, or a related degree that substitutes for part of the experience."
      },
      {
        "q": "How is it different from the FPC?",
        "a": "The FPC is the entry credential with no experience barrier; the CPP is the senior mark requiring recent payroll experience."
      },
      {
        "q": "How do I keep it?",
        "a": "Renew every five years with 120 recertification credits (RCH) through approved education, or by retaking the exam."
      },
      {
        "q": "What is the pass mark?",
        "a": "PayrollOrg uses a scaled scoring model; you receive a pass/fail result and a content-area score report."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Get a PTIN",
      "Study the three SEE parts",
      "Pass Part 1, 2 and 3",
      "File Form 23 and fee",
      "Maintain with 72 CPE / 3 yrs"
    ],
    ...
    "timeline": [
      ...
      {
        "stage": "Test",
        "duration": "3.5 hrs per part"
      },
      {
        "stage": "Enrollment",
        "duration": "weeks after Form 23"
      }
    ],
    "costBreakdown": {
      "items": [
        ...
        {
          "item": "Form 23 enrollment",
          "fee": "$140"
        }
      ],
      "total": "$1,000 to $1,200",
      "footnote": "Part fee reflects the 2026 IRS-plus-PSI rate; it rose effective April 9, 2026."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "How hard is the EA exam?",
        "a": "Most candidates rate the SEE moderate. The material is broad but conceptual rather than calculation-heavy; Part 3 on procedures is often the easiest and Part 2 on businesses the hardest."
      },
      {
        "q": "How long does it take?",
        "a": "Plan three to six months while working, with each part needing a few weeks. Many candidates sit one part at a time and roll the result forward."
      },
      {
        "q": "Do I need a degree?",
        "a": "No. The SEE is the gate, not a degree. You do need an active PTIN and to pass a tax-compliance check when you apply for enrollment."
      },
      {
        "q": "How is the EA different from a CPA?",
        "a": "The CPA is a state license covering audit, tax and attestation with a 150-hour education rule, while the EA is an IRS credential focused on tax representation with no degree requirement."
      },
      {
        "q": "Does the EA expire?",
        "a": "Enrollment renews each year with the PTIN and requires 72 CPE hours over three years; letting CPE lapse can suspend your rights."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      ...
      "total": "$300 to $700",
      "footnote": "FPC fees are lower than the CPP; member rates apply."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "Who should take the FPC?",
        "a": "New payroll clerks, HR generalists who process payroll, and students; there is no experience requirement."
      },
      {
        "q": "How is it different from the CPP?",
        "a": "The FPC is entry-level and shorter, while the CPP requires three years of recent experience and covers more breadth at a senior level."
      },
      {
        "q": "How long is it valid?",
        "a": "Three years, after which you renew through PayrollOrg’s simpler FPC process."
      },
      {
        "q": "Does it help get the CPP?",
        "a": "Yes. Many candidates use the FPC to build fundamentals and confidence before attempting the senior CPP."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "costBreakdown": {
      ...
      "total": "$0",
      "footnote": "No fee; Intuit provides the training and assessment at no cost."
    },
    "difficulty": "Easy",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "No. The program is designed for newcomers and starts from the fundamentals of individual tax."
      },
      {
        "q": "What is the difference between Level 1 and 2?",
        "a": "Level 1 covers basic filing concepts; Level 2 builds to more complete individual returns before the assessment."
      },
      {
        "q": "Does it lead to a job?",
        "a": "Completing it can qualify you for Intuit’s seasonal remote tax-prep roles, depending on hiring needs and location."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      ...
      "Pass the 6-hour AFTR course and exam",
      "Consent to Circular 230",
      "Receive the annual Record of Completion"
    ],
    ...
    "examEssentials": [
      [
        "Requirement",
        "18 hours CE: 10 tax, 6 AFTR, 2 ethics"
      ],
      [
        "Rights",
        "Limited representation for returns prepared"
      ],
      [
        "Validity",
        "One filing season; renew annually"
      ],
      [
        "Directory",
        "Listed in the IRS public directory"
      ]
    ],
    "timeline": [
      {
      ...
      {
        "stage": "Issued",
        "duration": "each filing season"
      }
    ],
    "costBreakdown": {
      "items": [
        {
          "item": "AFTR course and exam",
          "fee": "$100 to $200"
        },
        {
          "item": "Additional CE",
      ...
      "total": "$150 to $350",
      "footnote": "Costs depend on the IRS-approved CE provider chosen."
    },
    "difficulty": "Easy",
    ...
    "faqs": [
      {
        "q": "Is the AFSP required to prepare returns?",
        "a": "No. Unenrolled preparers may file returns without it, but the AFSP gives limited representation rights and a directory listing that many clients look for."
      },
      {
        "q": "How is it different from the EA?",
        "a": "The EA requires passing the three-part SEE and grants unlimited representation; the AFSP is annual, lighter, and grants only limited rights for returns you prepared."
      },
      {
        "q": "Does it expire?",
        "a": "Yes. It is valid for one filing season and must be renewed each year with the full CE requirement."
      },
      {
        "q": "What is the AFTR?",
        "a": "The Annual Federal Tax Refresher is the six-hour course and exam at the heart of the AFSP, covering current-year federal tax law updates."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Apply when the IRS opens the window",
      "Complete mandatory ITIN training",
      "Complete forensic training (if applicable)",
      "Submit the electronic application",
      "Sign the CAA agreement"
    ],
    ...
    "examEssentials": [
      [
        "Authorization",
        "Certify ITIN identity documents"
      ],
      [
        "Training",
        "Mandatory ITIN + forensic (as applicable)"
      ],
      [
        "Application",
        "Electronic, via the IRS system"
      ],
      [
        "Reopened",
        "Applications reopened January 2024"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      ...
      "total": "Varies by practice",
      "footnote": "The IRS does not charge a standard public exam fee; costs are the practice’s own time and any vendor training."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "What does a CAA actually do?",
        "a": "A CAA reviews an applicant’s identity documents in person, certifies them, and forwards the Form W-7 so the applicant never mails original passports or IDs to the IRS."
      },
      {
        "q": "Is there a test?",
        "a": "There is required IRS training rather than a public exam; forensic document examiners also complete forensic training before certification."
      },
      {
        "q": "Why did the program pause?",
        "a": "The IRS suspended new CAA applications for several years and reopened them in January 2024 with updated mandatory training requirements."
      },
      {
        "q": "Do I need to be an EA or CPA?",
        "a": "No. The CAA is a distinct authorization; you apply through the IRS and complete its training, regardless of other credentials."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "examEssentials": [
      ...
      [
        "Eligibility",
        "CPA or business degree + experience"
      ],
      [
        "Maintain",
        "NACVA CPE and membership"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Training and exam",
          "fee": "$1,000 to $2,500"
        }
      ],
      "total": "$1,000 to $3,000",
      "footnote": "NACVA members receive a discount on training and exam fees."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "Do I need a CPA for the CVA?",
        "a": "No. A CPA is the common path, but NACVA also accepts a business degree with sufficient valuation experience."
      },
      {
        "q": "What is the case requirement?",
        "a": "Beyond the exam you submit a case study or a sanitized valuation report showing you can perform a real engagement to standard."
      },
      {
        "q": "How does it compare to the ABV?",
        "a": "Both certify business valuators; the CVA adds a required case submission and is open to non-CPAs, while the ABV is AICPA and CPA-centric."
      },
      {
        "q": "Is there a forensics track?",
        "a": "Yes. The MAFF builds on the CVA core with a financial-forensics specialty track."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Earn or hold the CVA core",
      "Choose a specialty track",
      "Complete track coursework",
      "Pass the specialty assessment",
      "Maintain with CPE"
    ],
    ...
    "costBreakdown": {
      "items": [
        {
          "item": "Track training and exam",
          "fee": "$1,000 to $2,500"
        }
      ],
      "total": "$1,000 to $2,500",
      "footnote": "In addition to CVA costs; members receive discounts."
    },
    "difficulty": "Hard",
    ...
    "faqs": [
      {
        "q": "What is the MAFF?",
        "a": "The Master Analyst in Financial Forensics is NACVA’s forensic specialty that extends the CVA valuation core with a focused track in areas like damages or bankruptcy."
      },
      {
        "q": "Do I need the CVA first?",
        "a": "The CVA core generally underpins the MAFF, so most candidates earn or hold the CVA before adding the forensic specialty track."
      },
      {
        "q": "What specialty tracks exist?",
        "a": "Common tracks include commercial damages, bankruptcy and insolvency, and other NACVA-approved forensic focuses."
      },
      {
        "q": "How does it compare to the CFF?",
        "a": "The CFF is the AICPA’s CPA-only forensic credential; the MAFF is NACVA-based and builds on the CVA valuation foundation."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      ...
      "Pass the ProAdvisor exam",
      "List in the directory",
      "Renew with new versions"
    ],
    ...
    "costBreakdown": {
      ...
      "total": "$0",
      "footnote": "No fee; Intuit provides the training and exam."
    },
    "difficulty": "Easy",
    ...
    "faqs": [
      {
        "q": "Is the ProAdvisor cert worth it?",
        "a": "For anyone doing QuickBooks work it is effectively expected, and the free price plus directory listing make it an easy credibility boost."
      },
      {
        "q": "Do I need accounting experience?",
        "a": "No. It tests product features, though bookkeeping knowledge helps you apply them well."
      },
      {
        "q": "How do I keep it current?",
        "a": "You renew as Intuit releases new versions, usually by completing updated training and the exam."
      },
      {
        "q": "Does it make me a licensed bookkeeper?",
        "a": "No. It certifies QuickBooks product skill, not a license; pair it with the AIPB CB for formal bookkeeping recognition."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Hold a PTIN",
      "Study individual taxation",
      "Schedule Part 1 with PSI",
      "Pass at scaled 500",
      "Move to Parts 2 and 3"
    ],
    ...
    "examEssentials": [
      ...
      [
        "Order",
        "May be taken before Parts 2 and 3"
      ]
    ],
    "timeline": [
      {
    ...
    "costBreakdown": {
      ...
      "total": "$317 per part",
      "footnote": "2026 IRS-plus-PSI rate effective April 9, 2026."
    },
    "difficulty": "Moderate",
    ...
    "faqs": [
      {
        "q": "Can I take Part 1 first?",
        "a": "Yes. The three SEE parts may be taken in any order; many start with individuals because it is the most familiar."
      },
      {
        "q": "How hard is Part 1?",
        "a": "Most candidates find Part 1 moderate. It rewards methodical study of the individual provisions rather than advanced calculations."
      },
      {
        "q": "What score do I need?",
        "a": "Under PSI a scaled 500 on the 200 to 800 scale. The old Prometric scale used a 105 pass, but the 2026 transition changed scoring."
      },
      {
        "q": "Does passing Part 1 make me an EA?",
        "a": "No. You must pass all three parts and then file Form 23 to be enrolled; a single part keeps its validity while you finish."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      "Hold a PTIN",
      "Study entity taxation",
      "Schedule Part 2 with PSI",
      "Pass at scaled 500",
      "Move to remaining parts"
    ],
    "prerequisites": "An active PTIN to sit; no degree required. Parts may be attempted in any sequence.",
    "examMeta": {
      "questions": "100 questions (85 scored + 15 pretest)",
    ...
    "examEssentials": [
      ...
      [
        "Order",
        "May be taken before or after Parts 1 and 3"
      ]
    ],
    "timeline": [
      {
    ...
    "faqs": [
      {
        "q": "Is Part 2 the hardest SEE paper?",
        "a": "Many candidates find Part 2 the most technical because of entity rules, basis and specialized filings, so budget extra study time for it."
      },
      {
        "q": "Can I take it before Part 1?",
        "a": "Yes. The order is up to you; some prefer to do businesses after individuals to build confidence."
      },
      {
        "q": "What score do I need?",
        "a": "A scaled 500 on the 2026 PSI 200 to 800 scale; the older Prometric pass was 105."
      },
      {
        "q": "Does passing Part 2 make me an EA?",
        "a": "No. All three parts plus Form 23 enrollment are required for the credential."
      }
    ],
    "summaryPoints": [
  ...
  },
  {
    ...
    "roadmap": [
      ...
      "Schedule Part 3 with PSI",
      "Pass at scaled 500",
      "File Form 23 to enroll"
    ],
    "prerequisites": "An active PTIN to sit; no degree required. Parts may be attempted in any sequence.",
    "examMeta": {
      "questions": "100 questions (85 scored + 15 pretest)",
    ...
    "examEssentials": [
      [
        "Scope",
        "Procedures, representation, ethics"
      ],
      [
        "Scoring",
        "200 to 800; pass 500"
      ...
      [
        "Order",
        "May be taken before or after Parts 1 and 2"
      ]
    ],
    "timeline": [
      {
    ...
    "faqs": [
      {
        "q": "Is Part 3 the easiest SEE paper?",
        "a": "Many candidates find Part 3 the most straightforward because it is conceptual and procedural rather than calculation-heavy, though it still demands knowing Circular 230."
      },
      {
        "q": "What does it cover?",
        "a": "Practitioner duties, how to represent clients before the IRS, filing and penalty procedures, and the ethical rules every practitioner must follow."
      },
      {
        "q": "What score do I need?",
        "a": "A scaled 500 on the 2026 PSI 200 to 800 scale."
      },
      {
        "q": "After passing all three, what next?",
        "a": "File Form 23 with the enrollment fee and clear a tax-compliance check; once approved you are an Enrolled Agent with unlimited representation rights."
      }
    ],
    "summaryPoints": [
