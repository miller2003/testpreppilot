// Depth content for: cma-part-2
// CMA Part 2: Strategic Financial Management. All figures verified 2026-08.
const data = {
  author: {
  ...
  salaryOutlook: {
    ...
    growth: '+5% projected change 2024-34 for accountants and auditors (faster than average), with about 124,200 openings a year; the CMA targets the strategic financial-management and corporate-finance segment of the occupation where corporate-side pay is highest.',
    source: {
  ...
  studyPlan: {
    summary:
      'A realistic CMA Part 2 study plan runs 12 to 16 weeks at 8 to 12 hours a week, because the part is a breadth exam with a written component and the fastest score gains come from weighting study time to the domain that carries the most points. The IMA Content Specification Outline for Part 2, Strategic Financial Management, is the scope map: Financial Statement Analysis at 20 percent of the exam, Corporate Finance at 20 percent, Decision Analysis at 25 percent, Risk Management at 10 percent, Investment Decisions at 10 percent, and Professional Ethics at 15 percent, so a candidate who studies the six domains equally will under-prepare the decision-analysis block that is the single largest on the paper. The study window should split into a content-coverage phase (weeks 1-8) working the domains in weight order \u2014 starting with decision analysis (cost-volume-profit analysis, marginal analysis, pricing, and the make-versus-buy and sell-or-process-further decisions), then financial statement analysis (ratio analysis, profitability and liquidity measures, and the effects of accounting choices on reported numbers) and corporate finance (risk and return, cost of capital, raising capital, working-capital management and corporate restructuring), then investment decisions (capital budgeting, net present value and internal rate of return), risk management and professional ethics \u2014 followed by a drilling phase (weeks 9-12) with the question bank, then a final block (weeks 13-16) of full timed practice exams at the real 4-hour format, including the written section. The written section is the part candidates underestimate: the two essay or case-based questions reward showing your calculations and reasoning, so the plan must include at least a few timed written responses, not just multiple-choice drilling. The multiple-choice section is scored first and gates the essays, so practice performance on the 100-question block should clear the bar before the exam. Confirm your testing window, your IMA membership status and the fee structure \u2014 roughly $545 per part for professionals, less for students, plus the entrance fee and IMA dues \u2014 and plan against the three-year clock to pass both parts.',
    totalHours: '100-160 hours over 12-16 weeks',
    weeks: [
      { label: 'Weeks 1-2', focus: 'Decision analysis (25%)', tasks: ['Master cost-volume-profit analysis and marginal analysis', 'Study pricing decisions and the make-versus-buy, sell-or-process-further and special-order decisions', 'Drill the quantitative decision-analysis problems until they are automatic'], hours: '10-12 hrs/week' },
      { label: 'Weeks 3-4', focus: 'Financial statement analysis (20%)', tasks: ['Master ratio analysis, profitability and liquidity measures', 'Study the effects of accounting choices on reported numbers', 'Practise interpreting a set of financial statements under time'], hours: '10-12 hrs/week' },
      { label: 'Weeks 5-6', focus: 'Corporate finance (20%)', tasks: ['Study risk and return, and the cost of capital', 'Cover raising capital, working-capital management and corporate restructuring', 'Drill the cost-of-capital and working-capital calculations'], hours: '10-12 hrs/week' },
      { label: 'Week 7', focus: 'Investment decisions (10%)', tasks: ['Master capital budgeting: net present value and internal rate of return', 'Study discounted-cash-flow analysis for project selection', 'Practise the NPV and IRR calculations and the decision rules'], hours: '10-12 hrs' },
      { label: 'Week 8', focus: 'Risk management and professional ethics (25% combined)', tasks: ['Study enterprise risk identification, assessment and mitigation', 'Cover the IMA Statement of Ethical Professional Practice', 'Practise the ethics scenarios, which are highly coachable'], hours: '10-12 hrs' },
      ...
      { label: 'Weeks 13-16', focus: 'Full-format rehearsal and gap closing', tasks: ['Two or three full 4-hour practice exams under real timing', 'Re-drill the weakest domains from the error log', 'Final pass over CVP analysis, capital budgeting and the ethics scenarios'], hours: '10-12 hrs/week' }
    ],
    variants: [
      { label: 'Working in financial analysis or corporate finance', detail: 'Ten to twelve weeks. Your day job covers corporate finance and statement analysis; spend the recovered time on decision analysis, risk management and the written-section format.' },
  ...
  prepStrategies: {
    summary:
      'The strategy that reliably passes CMA Part 2 is "weight the blueprint, drill the quantitative domains, and rehearse the written section," because the IMA outline puts Decision Analysis at 25 percent \u2014 the largest domain on the paper \u2014 and the exam rewards fluent calculation in the decision, finance and investment areas as much as concept knowledge. Start by getting the IMA Content Specification Outline and baselining with a section-level practice set, logging every miss to a domain. Second, weight the quantitative domains hardest: decision analysis (cost-volume-profit, marginal analysis, pricing and the make-versus-buy decisions), corporate finance (risk and return, cost of capital, working-capital management) and investment decisions (net present value and internal rate of return) together carry 55 percent of the paper, and the calculations that live there are the highest-yield drilling targets \u2014 a candidate who can perform CVP and NPV arithmetic fluently clears the multiple-choice gate far more reliably than one who only recognises the concepts. Third, drill the financial-statement-analysis content deliberately: ratio analysis, profitability and liquidity measures, and the effects of accounting choices on reported numbers are 20 percent of the paper and are the items that reward knowing both the ratios and what they mean. Fourth, rehearse the written section explicitly: the two essay or case-based questions reward showing your calculations and reasoning in order, and a candidate who can think through a capital-budgeting or pricing analysis but cannot write it up under time loses the 25 percent of the score the written section carries. Fifth, do not skip risk management and professional ethics: together they are 25 percent of the paper, and the ethics scenarios are the most coachable content on the exam \u2014 the IMA Statement of Ethical Professional Practice is a closed, learnable set. Finally, rehearse the full 4-hour format at least twice, because the multiple-choice-to-essay rhythm and the pacing need to be trained, and confirm the essay-versus-case-based-question format that applies to your testing window.',
    items: [
      { title: 'Weight the quantitative domains', detail: 'Decision Analysis (25%), Corporate Finance (20%) and Investment Decisions (10%) carry 55% of the paper. Drill CVP, cost-of-capital and NPV calculations until automatic.' },
      { title: 'Master financial statement analysis', detail: 'Ratio analysis, profitability and liquidity measures, and the effects of accounting choices are 20% of the paper \u2014 know both the ratios and what they mean.' },
      ...
      { title: 'Do not skip risk management and ethics', detail: 'Together they are 25% of the paper, and the ethics scenarios are the most coachable content on the exam \u2014 the IMA Statement of Ethical Professional Practice is a closed, learnable set.' },
      { title: 'Rehearse the full 4-hour format', detail: '100 multiple-choice in 3 hours plus 2 written in 1 hour. Run at least two full timed exams so the multiple-choice-to-essay rhythm and the pace are trained.' },
  ...
  resourceComparison: {
    ...
    rows: [
      ...
      { label: 'CMA Part 2 exam (IMA)', values: ['~$545/part + $300 entrance + IMA dues (2026)', 'Prometric centre or ProProctor online, 4 hours', 'Required \u2014 plus the written section and the 360 pass mark'] },
  ...
  commonMistakes: {
    summary:
      'The most common CMA Part 2 mistake is studying the six domains equally, because Decision Analysis carries 25 percent \u2014 the largest single domain on the paper \u2014 and a candidate who divides time evenly under-prepares the quantitative block that effectively decides the pass. The second is treating the written section as an afterthought: the two essay or case-based questions are 25 percent of the score, and candidates who drill only multiple choice arrive unable to show their calculations and reasoning under time, losing a quarter of the paper to format. A third recurring error is misunderstanding the multiple-choice gate: your essays are not graded unless the multiple-choice section clears roughly the 50 percent level, so a candidate who banks on strong essays to carry a weak multiple-choice performance gets no credit for them at all. Candidates also routinely under-drill the quantitative content \u2014 cost-volume-profit analysis, net present value, the cost of capital and the decision-analysis problems \u2014 because the concepts feel familiar, when the exam rewards fluent arithmetic and the calculation items are where time pressure bites. Another pattern is skipping the professional-ethics domain, which is 15 percent of the paper and the most coachable content on the exam, because traditional accountants dismiss it as soft, even though the IMA Statement of Ethical Professional Practice is a closed, learnable set. Finally, some candidates mismanage the structural clock: they sit a part without running a full 4-hour timed exam, so the multiple-choice-to-essay rhythm surprises them, or they let the three-year completion clock slip after a failed attempt, which costs the full per-part fee and a full testing window. A last pattern is confusion about the written-section transition: candidates in 2026 windows must confirm whether their sitting uses essays or the newer case-based questions, because preparing for the wrong format wastes the most expensive study hours.',
    items: [
      { mistake: 'Studying the six domains equally', fix: 'Decision Analysis is 25% of the paper \u2014 the largest domain. Weight your hours to the blueprint, with the quantitative finance domains carrying the most time.' },
      ...
      { mistake: 'Under-drilling the quantitative content', fix: 'CVP, NPV, cost of capital and the decision-analysis problems reward fluent arithmetic. Drill them until automatic \u2014 the calculation items are where time pressure bites.' },
      { mistake: 'Skipping professional ethics', fix: 'Professional Ethics is 15% of the paper and the most coachable content on the exam. The IMA Statement of Ethical Professional Practice is a closed, learnable set \u2014 master it.' },
  ...
  questionTypes: {
    summary:
      'CMA Part 2, Strategic Financial Management, is a 4-hour computer-based exam of 100 multiple-choice questions in 3 hours plus 2 essay or case-based questions in 1 hour, with the multiple-choice section worth 75 percent of the score and the written section 25 percent, scored on a 0-500 scale with a passing mark of 360 and a multiple-choice gate that must clear roughly 50 percent before the essays are graded. The multiple-choice items are four-option single-best-answer questions drawn from the six domains of the IMA Content Specification Outline \u2014 Financial Statement Analysis (20 percent), Corporate Finance (20 percent), Decision Analysis (25 percent), Risk Management (10 percent), Investment Decisions (10 percent), and Professional Ethics (15 percent) \u2014 and they run from concept questions to calculation items on cost-volume-profit analysis, capital budgeting, the cost of capital and working-capital management. The written section presents two questions that combine scenario analysis with calculations and written reasoning: traditional essays ask you to compute and explain in prose, while the newer case-based questions present a business case with interactive prompts such as select-from-list, drag-and-drop and calculation entry, but both are graded for the same 25 percent of the part. The calculation items are the defining feature of Part 2: the decision-analysis problems, the net present value and internal rate of return computations, and the cost-of-capital and ratio calculations appear across the three largest domains, and candidates who can perform the arithmetic fluently clear the multiple-choice gate far more reliably than candidates who only recognise the concepts. The practical pacing is about 108 seconds per multiple-choice question, with the written section timed separately. The samples below illustrate a concept item, a calculation item and an ethics scenario; they are editor-written to the published Content Specification Outline and are not live exam items.',
    types: [
      { name: 'Concept and framework items', share: 'Across all six domains', detail: 'Definitions and applications of decision analysis, corporate finance, risk and ethics concepts \u2014 the fastest items for a candidate who studied the blueprint.' },
      { name: 'Calculation items', share: 'Heaviest in decision analysis, corporate finance and investments', detail: 'CVP, NPV, IRR, cost of capital and ratio calculations \u2014 the defining feature of Part 2, where fluent arithmetic clears the multiple-choice gate.' },
      { name: 'Scenario-based multiple choice', share: 'A recurring share', detail: 'A described business situation asking for the correct financial, investment or risk-management decision.' },
      { name: 'Ethics scenario items', share: '15% of the exam', detail: 'A professional situation asking which course of action the IMA Statement of Ethical Professional Practice requires \u2014 the most coachable content on the exam.' },
    ...
    samples: [
      {
        prompt: 'A company is deciding whether to make a component internally or buy it from an outside supplier. Which cost should be included in the make-versus-buy analysis?',
        options: [
          'A. All fixed costs, including unavoidable ones',
          'B. Only the relevant costs \u2014 the differential, avoidable costs between the alternatives',
          'C. Sunk costs from the original equipment purchase',
          'D. The book value of existing inventory'
        ],
        answer: 'B',
        explanation: 'Relevant-cost analysis includes only the differential, avoidable costs that change between the alternatives \u2014 the costs that differ between making and buying \u2014 and excludes sunk costs and unavoidable fixed costs. A includes costs that do not change, C and D are sunk costs that cannot be changed by the decision. The item tests the decision-analysis content of the largest domain \u2014 the relevance rules that govern the make-versus-buy, special-order and sell-or-process-further decisions, which are the heart of Part 2.'
      },
      {
        prompt: 'A project requires an initial investment of $100,000 and is expected to generate cash inflows of $40,000 per year for 3 years. Using a discount rate of 10%, what is the approximate net present value? (Present value factors: year 1, 0.909; year 2, 0.826; year 3, 0.751.)',
        options: [
          'A. -$600',
          'B. $0',
          'C. -$20,000',
        ...
        answer: 'A',
        explanation: 'Discount the cash inflows: $40,000 times 0.909 is $36,360, times 0.826 is $33,040, and times 0.751 is $30,040, for a total present value of inflows of $99,440. The net present value is that total minus the $100,000 initial investment, which is approximately -$560, closest to -$600. B, C and D are the common miscalculations \u2014 ignoring the discounting, mis-stacking the present values, or reversing the sign. The item tests the capital-budgeting calculation of the Investment Decisions domain, where NPV fluency is exactly what the exam rewards.'
      },
      {
        prompt: 'A management accountant is asked to classify an expense in a way that overstates a division\u2019s reported profit, against the accountant\u2019s professional judgment. Which course of action is most consistent with the IMA Statement of Ethical Professional Practice?',
        options: [
          'A. Comply, because the request came from a superior',
          'B. Refuse to misstate the information and follow the company\u2019s established policies for reporting ethical conflicts',
          'C. Comply but document the disagreement privately',
          'D. Leave the decision to the internal auditor'
        ],
        answer: 'B',
        explanation: 'The IMA Statement of Ethical Professional Practice requires members to refrain from engaging in conduct that prejudices their duty of objectivity and integrity, to refuse gifts or pressures that influence actions, and to follow the company\u2019s established policies for communicating ethical conflicts. A complies with a request that violates professional standards, C complies while privately documenting, and D delegates a professional responsibility. The item tests the ethics domain \u2014 the closed, learnable set of IMA ethical duties that is the most coachable content on Part 2.'
      }
    ],
  ...
  examDay: {
    ...
    timeline: [
      ...
      { time: 'After a pass', detail: 'Diary the three-year completion clock for Part 1 and the two-year experience requirement.' }
    ],
    rules: [
    ...
    afterwards:
      'Your score report is delivered on screen at the end of the exam, and the immediate next step on a pass is the structural one: log the three-year completion clock, because you must pass Part 1 within three years of entering the program and complete two years of continuous professional experience within seven years to earn the CMA credential, and on a fail, use the score report to identify the weaker section \u2014 for most candidates that is either the multiple-choice gate or the written section \u2014 rehearse that section specifically, and re-sit in a later window at the full per-part fee. Once certified, the CMA requires 30 hours of continuing professional education each year, including at least 2 hours of ethics, plus the IMA membership dues, so the credential is a maintenance commitment rather than a one-time purchase. Either way, the occupation behind the credential is the context: accountants and auditors earned a BLS median of $81,680 in May 2024 with about 124,200 openings a year, and the CMA positions you for the strategic financial-management and corporate-finance segment of that occupation where corporate-side pay is highest \u2014 the practical return on a roughly $1,000-plus first-year investment and the three-year completion clock.'
  }
};
