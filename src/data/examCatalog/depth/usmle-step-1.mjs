// Depth content for: usmle-step-1
// USMLE Step 1
const data = {
  author: {
  ...
  reviewedBy: 'Verified the Step 1 format (up to 280 multiple-choice items in an 8-hour session, in seven 60-minute blocks before 14 May 2026 and fourteen 30-minute blocks on or after that date), pass/fail reporting since January 2022, the $695 fee for 2026, and the BLS May 2024 physician median of $239,200+ against usmle.org and bls.gov.',
  ...
  salaryOutlook: {
    ...
    growth: '+3% projected change 2024-34 for physicians and surgeons, with roughly 23,600 openings a year; Step 1 is the licensing gate into the occupation, and the earnings trajectory follows the specialty chosen in the residency match rather than the exam result.',
    source: {
  ...
  passRate: {
    headline: 'Step 1 has reported pass/fail only since January 2022, and no numeric score is published \u2014 the USMLE does publish performance data by examinee group, and US MD senior first-time pass rates have been roughly 90-93% in recent years, with IMG rates lower',
    summary:
  ...
  studyPlan: {
    ...
    totalHours: '350-500 hours over a 6-10 week dedicated period (50-70 hrs/week)',
    weeks: [
      { label: 'Week 1', focus: 'Baseline and blueprint', tasks: ['Take a baseline NBME or official self-assessment and log weaknesses by organ system and discipline', 'Set the study plan around the integrated content outline, not a generic review', 'Confirm your eligibility window, registration, and the block structure you will face on your test date'], hours: '50-60 hrs' },
      { label: 'Weeks 2-7', focus: 'High-yield content and daily questions', tasks: ['Work pathology, physiology and pharmacology \u2014 the dominant disciplines \u2014 in clinical-vignette context', 'Do 80-120 practice questions daily with full review of every answer, including the wrong options', 'Cover biochemistry, microbiology, immunology, anatomy, genetics and biostatistics through the same vignette lens'], hours: '55-70 hrs/week' },
      { label: 'Weeks 7-8', focus: 'Progress checks and full exams', tasks: ['Take NBME self-assessments to track readiness and identify remaining gaps', 'Run two or three full simulated exams under the real block structure and timing', 'Re-drill the organ systems or disciplines still dragging the performance'], hours: '55-65 hrs/week' },
      { label: 'Weeks 9-10', focus: 'Targeted gaps and taper', tasks: ['One or two more full exams under real conditions', 'Targeted review of the weakest areas only', 'Taper the workload in the final days and protect sleep'], hours: '40-50 hrs/week' }
    ],
    variants: [
      { label: 'Weak baseline (low NBME score at start)', detail: 'Extend the dedicated period to 10-12 weeks and start with a content pass on the weakest organ systems before adding heavy question volume. The pass line is real, and a weak baseline needs repair before it needs polishing.' },
      { label: 'Strong baseline (approaching readiness at start)', detail: 'Compress to 6-7 weeks and lean on daily questions and full simulated exams rather than content review. Your job is maintaining the pass margin and building the 8-hour stamina.' },
      { label: 'International medical graduate', detail: 'Plan 10-14 weeks and budget extra time for the format transition and any content gaps from the home curriculum. Confirm the FSMB registration route and the $210 international surcharge, and note that IMG first-time pass rates run lower than US MD rates.' }
    ]
  },
  prepStrategies: {
    summary:
    ...
    items: [
      {
        title: 'Make the question bank the backbone',
        detail: '80-120 practice questions daily with a full review of every answer, including why each incorrect option is wrong. The vignette style and the reasoning patterns are learned through volume, and the review is where the mechanism thinking is demonstrated.'
      },
      {
        title: 'Use NBME self-assessments as progress checks',
        detail: 'They are the closest predictors of readiness. Take one at baseline, one at mid-dedicated-period, and one or two near the end, and let the results direct the final weeks rather than studying by feel.'
      },
      {
        title: 'Weight the dominant disciplines',
        detail: 'Pathology, physiology and pharmacology dominate the blueprint. Study them in a clinical context \u2014 mechanisms, disease associations and how the vignette points to the diagnosis \u2014 because the pass line rewards reasoning from a presentation, not isolated recall.'
      },
      {
        title: 'Train the 8-hour day under your block structure',
        detail: 'Run full simulated exams under the exact format you will face \u2014 seven 60-minute blocks before 14 May 2026, fourteen 30-minute blocks on or after that date \u2014 including the break plan. The ability to reset and perform on each block is a testable skill, and the 8-hour stamina must be trained.'
      },
      {
        title: 'Review the wrong options, not just the right answer',
        detail: 'The item explanations are where the differential and mechanism thinking is demonstrated. A review that stops at the correct answer forfeits the teaching in every distractor you chose and every one you almost chose.'
      },
      {
        title: 'Protect the pass margin, not the pass/fail illusion',
        detail: 'Passing is the only reported outcome, but the pass line is real \u2014 roughly 60 percent of items correct, varying by form \u2014 and first-time pass rates are not 100 percent. The pass/fail format removes the score chase, not the preparation.'
      }
    ]
  },
  resourceComparison: {
    ...
    rows: [
      { label: 'UWorld Step 1 question bank', values: ['~$300-500 for a 90-180 day subscription', 'Online question bank with explanations', 'The standard backbone \u2014 where vignette reasoning is built'] },
      { label: 'NBME Step 1 self-assessments', values: ['~$60 each', 'Online scored self-assessments', 'The closest predictors of readiness; use as progress checks'] },
      { label: 'Official USMLE practice materials and interactive testing experience', values: ['Free', 'Online', 'Format familiarity \u2014 especially the new software for exams on or after 14 May 2026'] },
      { label: 'First Aid for the USMLE Step 1 and Anki decks', values: ['~$50-60 for First Aid; decks free-$20', 'Print text and flashcard app', 'Structured rapid review and spaced-repetition retention'] },
      { label: 'Video lecture supplements (Pathoma, Sketchy, Boards and Beyond)', values: ['~$100-200', 'Streaming video', 'Explaining the high-yield pathology, microbiology and pharmacology content'] },
      { label: 'The Step 1 exam itself', values: ['$695 (2026) plus a $210 international surcharge outside the US/Canada', 'One-day, ~8-hour exam at a Prometric centre', 'Required \u2014 the licensing gate'] }
    ],
    footnote: 'Prices dated 2025-26 and change annually; include the $695 exam fee in planning. We do not rank by commission.'
  },
  commonMistakes: {
    summary:
    ...
    items: [
      {
        mistake: 'Treating pass/fail as a reason to under-prepare',
        fix: 'Pass/fail removes the score chase, not the pass line \u2014 the exam still tests up to 280 items in an 8-hour day, the pass standard corresponds to roughly 60% of items correct, and first-time pass rates are not 100%. Prepare to protect the margin, not to chase a number.'
      },
      {
        mistake: 'Passive review without daily questions',
        fix: 'The exam tests vignette reasoning, which is built through volume. Do 80-120 practice questions daily with full review \u2014 reading alone builds recognition of topics, not the reasoning the exam rewards.'
      },
      {
        mistake: 'Skipping NBME self-assessments',
        fix: 'The NBME assessments are the closest predictors of readiness. Take one at baseline, mid-dedicated-period and near the end \u2014 avoiding them for fear of a low result forfeits the most useful calibration data you can get.'
      },
      {
        mistake: 'Reviewing only the correct answer',
        fix: 'Review every answer, including why each incorrect option is wrong. The explanations are where the mechanism and differential thinking is demonstrated, and a review that stops at the right answer forfeits most of the learning.'
      },
      {
        mistake: 'Rehearsing the wrong block structure',
        fix: 'Check your test date: examinations before 14 May 2026 use seven 60-minute blocks; examinations on or after that date use fourteen 30-minute blocks with the new software. Train full exams in the format you will actually face, including the break plan.'
      },
      {
        mistake: 'Chasing pre-2022 numeric score norms',
        fix: 'No numeric score is reported to anyone since January 2022. Studying toward a remembered "target score" misallocates energy; the reported outcome is pass or fail, so calibrate readiness with NBME pass predictors and protect the pass margin instead.'
      }
    ]
  },
  questionTypes: {
    ...
    types: [
      { name: 'Clinical vignette, single best answer', share: 'The dominant format', detail: 'A patient presentation with history, findings and data; choose the best single answer among distractors. Tests integrated reasoning across systems and disciplines.' },
      { name: 'Abstract and research-style items', share: 'A recurring minority', detail: 'Items mimicking scientific abstracts or study designs, asking you to interpret data tables, graphs or statistical findings \u2014 the biostatistics and epidemiology content lives here.' },
      { name: 'Multimedia items', share: 'A recurring minority', detail: 'Images, pathology slides, radiographs, ECGs and other findings embedded in the vignette \u2014 the visual diagnosis questions that reward exposure to the images.' }
    ],
    samples: [
      {
  ...
  examDay: {
    ...
    timeline: [
      { time: 'The week before', detail: 'Confirm the scheduling permit name matches your ID exactly, the test centre address, and which block structure applies to your date \u2014 seven 60-minute blocks before 14 May 2026, fourteen 30-minute blocks on or after.' },
      { time: '24 hours before', detail: 'Do not study new material. Review your error log once, pack your ID and snacks, and plan the break strategy. Sleep is the last high-yield intervention.' },
      { time: '30 minutes before', detail: 'Arrive at the Prometric centre, check in with ID, and complete the check-in process \u2014 biometric and security steps take real time.' },
      { time: 'Blocks 1-3 (or 1-7)', detail: 'Work each block within its fixed time, reviewing within the block before it closes \u2014 you cannot return to a closed block. Finish early where possible to bank break time.' },
      { time: 'Break time', detail: 'Use your accumulated break minutes deliberately \u2014 eat, move, reset mentally. The minimum allotment (45 or 55 minutes depending on your format) can only grow by finishing blocks early.' },
      { time: 'Blocks 4-7 (or 8-14)', detail: 'The back half of the day, where stamina decides. Start each block fresh, flag within-block items early, and protect the pace rather than dwelling.' },
      { time: '3-4 weeks after', detail: 'Your result posts to your USMLE account, reported as pass or fail only \u2014 no numeric score.' }
    ],
    rules: [
    ...
    afterwards:
      'Your result posts to your USMLE account roughly three to four weeks after the test, reported as pass or fail only, and the immediate next step on a pass is confirming your school or residency pathway \u2014 for US students the score is not sent to programs, which is exactly why Step 2 CK and the rest of the application carry more weight in the match than they did before 2022. On a fail, use the USMLE\u2019s performance feedback and the exam-day experience to diagnose the gap, re-train with the NBME self-assessments until they predict a pass, and re-sit within the attempt limits \u2014 a maximum of four lifetime attempts per Step and no more than three in any 12-month period \u2014 while confirming the block structure on your new test date if it falls on or after 14 May 2026. The pass/fail format does not change the exam\u2019s place in the career: passing Step 1 is the licensing gate into the physician occupation that BLS documents at a May 2024 median of $239,200 or more, with specialty and practice setting \u2014 not the exam result \u2014 driving the earnings trajectory from there.'
  }
};
