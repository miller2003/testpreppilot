...
export default [
   ...
   * ===================================================================== */
  {
    ...
    eligibility: 'Typically 18+ with a high-school diploma or equivalent; completion of a state-approved apprenticeship (commonly 8,000 hours / 4 years) or equivalent组合 of training and experience; some states accept military or degree credit. Proof of NEC familiarity.',
    exam: {
